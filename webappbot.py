...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Open the color picker!",
                web_app=WebAppInfo(url="https://python-telegram-bot.org/static/webappbot")),
            KeyboardButton(text="Give feedback", web_app=WebAppInfo(url="https://google.com"))]]
        )
    )
...
def main() -> None:
    ...
    application = Application.builder().token("5169952262:AAFre8RpGeXwC2wxBxmqwgdysP3rZ9B8hgM").build()
